...
select_data = ttk.Combobox(root, values=df['column_name'].tolist(), state='readonly')
select_data.pack()
...
def send_email():
    ...
    # Select attachments
    root.filename = filedialog.askopenfilenames(initialdir = "/", title = "Select files", filetypes = (("all files","*.*"),("jpeg files","*.jpg"),("png files","*.png"),("pdf files","*.pdf"),("text files","*.txt")))
